...
import static http.PageSearch.Result.completed;
import static http.PageSearch.Result.failed;
...
public class AsyncPageSearch implements PageSearch {
    ...
    AsyncPageSearch(HttpClient client) {
        this.client = client;
    }
    ...
    private CompletableFuture<Result> search(Search search) {
        ...
        return client
                ...
                .thenApply(contains -> completed(search, contains))
                .exceptionally(ex -> failed(search, ex));
    }
